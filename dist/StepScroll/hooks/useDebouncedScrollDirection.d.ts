...
export declare function useDebouncedScrollDirection({ upScrollCallback, downScrollCallback, isPreventDefault, debounceDelay, }: useDebouncedScrollDirectionArgs): "" | "up" | "down";
export {};
